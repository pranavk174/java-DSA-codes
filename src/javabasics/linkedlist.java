...
//        create a node
    ...
    public int removefirst(){  //delete 1st node
        ...
        else if (size == 1){     // if single node is present
            int val = head.data;
            head = tail = null;
            return val;
...
//        ll.removefirst();
//        System.out.println("after removing the 1stst node the new linked list is");
//        ll.printll();
//        System.out.println(ll.size);
//
//
        ll.removelast();
        System.out.println("after removing the last node the new linked list is");
        ll.printll();
        System.out.println(ll.size);
